...
<main>
	...
	<!-- main -->
		<div style=" margin:5px; width:850px;  float: left;">
			...
			<div style="text-align: center; margin: 5px; border: 1px solid lightgray;margin-left: -8px;margin-top: 2%;width: 1000px;padding-top: 8%;padding-left: 8%; padding-right: 8%; padding-bottom: 10%;">
