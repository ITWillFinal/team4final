...
<div style="overflow: hidden; width: 1055px; padding-left: 25px; font-size: 14px; margin-top: 10px;">
	<p style="font-weight: bold;font-size: xx-large;color: #010b1d; margin-top: 26px;">회사소개</p>
	...
	<div class="infoTop">
		...
		<div class="info_middle">
			...
			<div class="info_middle_write ">
				...
				<span>The JOB은 뜨거운 열정과 사명감, 이용자 중심의 혁신적인 마인드와 도전적인 기술력으로<br>
				'사람'과 '일'을 잇는 기업입니다.</span>
				<br><br><br><br>
				
				<h3>대한민국 대표 리크루팅 플랫폼</h3>
				<span>온라인 취업포털 The JOB은 국내 최대량의 공채정보와 유용한 취업 콘텐츠를<br>
				정확하고 신속하게 제공합니다.<br>
				THE JOB+는 발전된 기술력으로 구인 구직자를 효과적으로 매칭하여 대한민국을 대표하는<br> 
				리크루팅 플랫폼으로 자리매김 했습니다.</span>
				<br><br><br><br>
				
				<h3>사람을 먼저 생각하는 서비스</h3>
				<span>The JOB의 모든 서비스는 사람을 먼저 생각합니다. 구직자에게는 사회적 성취를 실현하고<br>
				행복한 삶의 터전이도리 일자리를, 기업에는 성장을 이끌 핵심인재를 연결합니다.<br>
