	...
	$(function(){
		...
		$(".password").keyup(function(){
			...
			if($(this).val()!=''){
				...
				$.ajax({
					url : "<c:url value='/member/outPwdChk.do' />",
					type : "get",
...
<main style="min-height: 600px">
		...
		<h1 style="background: white;font-weight: bold;">회원탈퇴</h1>
			<hr style="border: 1px solid #fb246a;">
		
		<form name="frmMember" method="post" action="<c:url value='/member/memberOut.do' />">
			...
			<div id="addDiv" class="divHide">
				...
				<table>
					<tr>
						<td>아이디 :</td>
						<td><input type="text" class="form-control" readonly value="${vo.userid}"></td>
						<td></td>
					</tr>
					<tr>
						<td>비밀번호 :</td>
					...
					<tr>
						<td>이메일인증 :</td>
						<td><input type="email" style="" class="form-control" id="email" name="email"
						data-rule-required="true" readonly maxlength="40" value="${vo.email}"></td>
						<td></td>
					</tr>
				</table>
