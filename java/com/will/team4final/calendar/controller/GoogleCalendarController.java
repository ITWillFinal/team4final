package com.will.team4final.calendar.controller;
...
import com.will.team4final.calendar.model.GoogleCalendarService;
import com.will.team4final.calendar.model.GoogleCalendarVO;
...
public class GoogleCalendarController {
	...
	public String coding(Model model) {
		...
		return "googleCalendar/coding";
	}

	// 캘린더 생성 처리
	@RequestMapping(value="/calendarAdd.do", method=RequestMethod.POST)

	public String calendarAdd(GoogleCalendarVO vo) {

		logger.info("calendarAdd "+vo.toString());

		try {
			Calendar service = GoogleCalendarService.getCalendarService();
			com.google.api.services.calendar.model.Calendar calendar = new com.google.api.services.calendar.model.Calendar();
			calendar.setSummary(vo.getSummary());
			calendar.setTimeZone("America/Los_Angeles");
			service.calendars().insert(calendar).execute();
		} catch (IOException e) {
			e.printStackTrace();
		}
		return "redirect:/googleCalendar/coding.do";
	}
	...
	public String calendarModify(GoogleCalendarVO vo) {
		logger.info("calendarModify "+vo.toString());

		try {

			Calendar service = GoogleCalendarService.getCalendarService();
			com.google.api.services.calendar.model.Calendar calendar = service.calendars().get(vo.getCalendarId()).execute();
			calendar.setSummary(vo.getSummary());
