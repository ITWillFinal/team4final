...
@Controller
@RequestMapping("/gogak/admin/company")
public class FaqCompanyAdminController {

	private final static Logger logger
		= LoggerFactory.getLogger(FaqCompanyAdminController.class);
	...
	public String faq_get(Model model, SearchVO searchVo) {
		...
		return "gogak/admin/company/faq";
	}
	...
	public String faqWrite_post(@ModelAttribute FaqCompanyVO vo,
		...
		String msg = "자주찾는 질문 등록 실패", url = "/gogak/admin/company/faqWrite";
		if(cnt>0) {
			msg = "자주찾는 질문 등록 성공";
			url = "/gogak/admin/company/faqList.do";
		}
	...
	public String faqList(@ModelAttribute SearchVO searchVo,
		...
		return "gogak/admin/company/faqList";
	}
	...
	public String selectByNo(@RequestParam(defaultValue = "0") int no,
		...
		return "gogak/admin/company/faqDetail";
	...
	public String editFaq_get(@RequestParam int no,
		...
		return "gogak/admin/company/faqEdit";
	...
	public String editFaq_post(@ModelAttribute FaqCompanyVO vo,
		...
		if(cnt>0) {
			msg = "자주 찾는 질문 수정 성공";
			url = "/gogak/admin/company/faqDetail.do?no="+vo.getfaqNo();
		}
	...
	public String delMulti(@ModelAttribute FaqCompanyListVO listvo,
		...
		String msg = "", url = "/gogak/admin/company/faqList.do";
		if(cnt>0) {
			msg = "선택한 게시글을 삭제했습니다.";
