...
@Component
public class MypageUseInterceptors extends HandlerInterceptorAdapter{
	private static final Logger logger = LoggerFactory.getLogger(MypageUseInterceptors.class);
