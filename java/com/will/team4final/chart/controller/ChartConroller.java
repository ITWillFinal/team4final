...
public class ChartConroller {
	...
	public void allChart(Model model) {
		...
		int s1 = chartService.sumByMonth("01");
		int s2 = chartService.sumByMonth("02");
		int s3 = chartService.sumByMonth("03");
		int s4 = chartService.sumByMonth("04");
		int s5 = chartService.sumByMonth("05");
		int s6 = chartService.sumByMonth("06");
		int s7 = chartService.sumByMonth("07");
		int s8 = chartService.sumByMonth("08");
		int s9 = chartService.sumByMonth("09");
		int s10 = chartService.sumByMonth("10");
		int s11 = chartService.sumByMonth("11");
		int s12 = chartService.sumByMonth("12");
