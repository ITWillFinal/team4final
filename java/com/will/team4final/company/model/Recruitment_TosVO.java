...
public class Recruitment_TosVO {
	private String recruitmentCode;
	private String comName;
	private String title; 
	private String jobType1;
	private String jobType2;
	private String induType1;
	private String induType2;
	...
	public String toString() {
		return "Recruitment_TosVO [recruitmentCode=" + recruitmentCode + ", comName=" + comName + ", title=" + title
				...
				+ comType + ", startDate=" + startDate + ", endDate=" + endDate + "]";
	}
