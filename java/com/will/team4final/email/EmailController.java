...
public class EmailController {
	...
	public String findId(@RequestParam String findIdByEmail, Model model) {
	...
	public String findPwd(@RequestParam String findPwdByEmail,@RequestParam String userid, Model model) {
